        ...
        DB::table('email_templates')->insert(
            [
                ...
                [
                    ...
                    <p><strong>%package_name%</strong> at cost of <strong>%package_price%</strong> which will be expired on <strong>%package_expiry%</strong>.</p>
                    <p>%signature%,</p>',
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ],
                ...
                [
                    ...
                    'subject' => 'Package Purchased',
                    'content' => '<p>Hello <strong><a href="%freelancer_link%">%freelancer_name%</a></strong>,</p>
                    <p>You have subscribed to the following <strong>%package_name%</strong> at cost of <strong>%package_price%</strong> which will be expired on <strong>%package_expiry%</strong>.</p>
                    <p>%signature%,</p>',
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ],
